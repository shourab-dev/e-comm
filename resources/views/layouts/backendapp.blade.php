    ...
    <div class="d-flex">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="javascript:;"
                        class="side-menu {{ Request::routeis('home') ? 'side-menu--active side-menu--open' : '' }} ">
                    ...
                    <ul class="{{ Request::routeis('home') ? 'side-menu__sub-open' : '' }}">
                        <li>
                ...
                <li>
                    <a href="javascript:;"
                        class="side-menu  {{ Request::routeis('brand*') ? 'side-menu--active side-menu--open' : '' }}">
                    ...
                    <ul class="{{ Request::routeis('brand*') ? 'side-menu__sub-open' : '' }}">
                        <li>
                            <a href="{{ route('brand') }}" class="side-menu side-menu--active side-menu--open">
                                <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                    ...
                    <ul class="{{ Request::routeis('brand*') ? 'side-menu__sub-open' : '' }}">
                        ...
                        <li>
                            <a href="{{ route("subcategory.add") }}"
                                class="side-menu side-menu--active side-menu--open">
                                <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="side-menu__title"> Add Sub-Category </div>
                            </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;"
                        class="side-menu  {{ Request::routeis('product*') ? 'side-menu--active side-menu--open' : '' }}">
                        <div class="side-menu__icon"> <i data-feather="award"></i> </div>
                        <div class="side-menu__title">
                            Products
                            <div class="side-menu__sub-icon"> <i data-feather="chevron-down"></i> </div>
                    ...
                    <ul class="{{ Request::routeis('product*') ? 'side-menu__sub-open' : '' }}">
                        <li>
                ...
                <div class="intro-x dropdown w-8 h-8">
                    ...
                    <div class="dropdown-menu w-56">
                        <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                            ...
                            <li>
                                <a href="{{ route('logout') }}"
                                    class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover" onclick="event.preventDefault();
