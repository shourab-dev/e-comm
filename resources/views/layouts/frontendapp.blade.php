            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link {{ count($category->subCategory) > 0 ? 'dropdown-toggle' : '' }}" href="#"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ str($category->title)->headline() }}
                        </a>
                        @if (count($category->subCategory) > 0)
                        <ul class="dropdown-menu">
                            @foreach ($category->subCategory as $subcategory)
                            <li><a class="dropdown-item" href="/products/{{ $subcategory->slug }}">{{
                                    $subcategory->title
                                    }}</a>
                            </li>
                            @endforeach
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('shop.product') }}">Shop</a>
                    </li>
               ...
               $.ajax({
                ...
                success: function(data){
                    ...
                    results.map(result => {
                        ...
                        let li = `<li><a href="/products/${result.slug}">${result.title}</a></li>`;
                        lists.push(li)
